...
const DISTRIBUTION_DEFINITIONS: DistributionDefinition[] = [
  ...
  },
  {
    ...
    category: "continuous",
    params: ["numeratorDf", "denominatorDf"],
  },
  {
    value: "binomial",
    category: "discrete",
...
export const DIST_PARAM_LABEL_KEYS: Record<string, string> = {
  ...
  degreesOfFreedom: "AddSimulationColumnForm.DegreesOfFreedom",
  numeratorDf: "AddSimulationColumnForm.NumeratorDf",
  denominatorDf: "AddSimulationColumnForm.DenominatorDf",
...
> = {
  ...
  chi_square: { degreesOfFreedom: 5 },
  f_distribution: { numeratorDf: 5, denominatorDf: 10 },
...
export const DIST_PARAM_SCHEMAS: Record<string, () => z.ZodTypeAny> = {
  ...
  degreesOfFreedom: gtZeroInt,
  numeratorDf: gtZeroInt,
  denominatorDf: gtZeroInt,
...
const DISTRIBUTION_BUILDERS = {
  ...
  f_distribution: (params) => ({
    type: "f_distribution",
    numeratorDf: params.numeratorDf,
    denominatorDf: params.denominatorDf,
  }),
  binomial: (params) => ({
    type: "binomial",
