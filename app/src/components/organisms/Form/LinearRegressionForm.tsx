...
export const LinearRegressionForm = ({
      ...
      try {
        ...
        if (regressionResponse.code === "OK" && regressionResponse.result) {
          ...
          if (resultResponse.code === "OK" && resultResponse.result) {
            // API繝ｬ繧ｹ繝昴Φ繧ｹ讒矩: { code: "OK", result: AnalysisResultDetail }
            // TypeScript逕滓・蝙九ｈ繧・谿ｵ豬・＞繝阪せ繝・
            const detail =
  ...
  return (
    ...
    >
      {/* 笏笏 TOP: 繝・・繝悶Ν驕ｸ謚橸ｼ亥・蟷・・繧ｳ繝ｳ繝代け繝茨ｼ・笏笏 */}
      ...
      {/* 笏笏 MIDDLE: 2繝壹う繝ｳ・亥､画焚驕ｸ謚・+ 繧ｪ繝励す繝ｧ繝ｳ・・笏笏 */}
      <div className="flex min-h-0 flex-1 gap-3">
        {/* 蟾ｦ: 螟画焚驕ｸ謚橸ｼ井ｸｻ蠖ｹ繝ｻflex-1・・*/}
