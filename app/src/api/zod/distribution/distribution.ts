...
export const PreviewDistributionBody = zod.object({
  ...
  "xCount": zod.number().min(previewDistributionBodyXCountMin).max(previewDistributionBodyXCountMax).default(previewDistributionBodyXCountDefault).describe('グラフ点数（連続分布）')
