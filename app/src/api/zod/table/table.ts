 ...
 */
export const CreateTableHeader = zod.object({
...
export const createTableBodyHasHeaderDefault = false;
export const createTableBodyCsvSeparatorDefault = `,`;
export const createTableBodyCsvSeparatorMax = 10;

export const createTableBodyCsvEncodingDefault = `utf8`;
export const createTableBodyExcelSheetNameOneMax = 31;
...
export const CreateTableResponse = zod.unknown()
...
export const CreateJoinTableResponse = zod.unknown()
...
export const CreateUnionTableResponse = zod.unknown()
...
export const CreateSimulationDataTableResponse = zod.unknown()
...
export const DeleteTableResponse = zod.unknown()
...
export const DuplicateTableResponse = zod.unknown()
...
export const RenameTableResponse = zod.unknown()
...
export const GetTableListResponse = zod.unknown()
...
export const ClearTablesResponse = zod.unknown()
 ...
 */
export const InputCellDataHeader = zod.object({
  "X-Auth-Token": zod.string().optional().describe('Tauri 起動時に生成された認証トークン')
})
...
export const InputCellDataResponse = zod.unknown()
 ...
 */
export const FilterSingleConditionHeader = zod.object({
  "X-Auth-Token": zod.string().optional().describe('Tauri 起動時に生成された認証トークン')
})
...
export const FilterSingleConditionResponse = zod.unknown()
