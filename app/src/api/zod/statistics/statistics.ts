...
export const ConfidenceIntervalResponse = zod.unknown()
...
export const DescriptiveStatisticsResponse = zod.unknown()
...
export const CreateCorrelationTableResponse = zod.unknown()
...
export const StatisticalTestResponse = zod.unknown()
