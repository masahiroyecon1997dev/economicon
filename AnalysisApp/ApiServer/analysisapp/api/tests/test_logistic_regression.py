...
class TestApiLogisticRegression(APITestCase):
    def setUp(self):
    ...
    def test_logistic_regression_success(self):
        """正常にロジット分析が実行できる"""
        payload = {
    ...
    def test_logistic_regression_multiple_variables(self):
    ...
    def test_logistic_regression_invalid_table(self):
        """存在しないテーブル名でエラーが返される"""
        payload = {
