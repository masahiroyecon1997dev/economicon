...
class TestApiAddSimulationColumn(APITestCase):
    ...
    def test_add_uniform_column_success(self):
        ...
        self.assertEqual(response_data['result']['distributionType'],
                         'uniform')
    ...
    def test_unsupported_distribution(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response_data['code'], 'NG')
        self.assertIn("distributionType 'unsupported' is not supported",
                      response_data['message'])
    ...
    def test_invalid_uniform_params(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response_data['code'], 'NG')
        self.assertIn("'low' must be less than 'high'",
                      response_data['message'])
