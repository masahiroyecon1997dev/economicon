...
class TestApiTransformColumn(APITestCase):
    ...
    def test_transform_column_log_natural_success(self):
        ...
        expected_ln_values = [math.log(1), math.log(2), math.log(4), math.log(8), math.log(16)]
    ...
    def test_transform_column_log_base2_success(self):
        ...
        expected_log2_values = [0, 1, 2, 3, 4]  # log2(1), log2(2), log2(4), log2(8), log2(16)
    ...
    def test_transform_column_power_square_success(self):
        ...
        expected_square_values = [1, 4, 16, 64, 256]  # 1^2, 2^2, 4^2, 8^2, 16^2
    ...
    def test_transform_column_power_cube_success(self):
        ...
        expected_cube_values = [1, 8, 64, 512, 4096]  # 1^3, 2^3, 4^3, 8^3, 16^3
    ...
    def test_transform_column_invalid_source_column(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response_data['code'], 'NG')
        self.assertEqual(response_data['message'], "sourceColumnName 'Z' does not exist.")
    ...
    def test_transform_column_duplicate_column_name(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response_data['code'], 'NG')
        self.assertEqual(response_data['message'], "newColumnName 'B' already exists.")
    ...
    def test_transform_column_invalid_method(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response_data['code'], 'NG')
        self.assertIn("transformMethod 'invalid' is invalid", response_data['message'])
    ...
    def test_transform_column_invalid_log_base(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response_data['code'], 'NG')
        self.assertIn("logBase must be a positive number not equal to 1", response_data['message'])
