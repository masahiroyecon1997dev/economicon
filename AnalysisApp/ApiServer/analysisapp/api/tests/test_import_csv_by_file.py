...
from ..apis.import_csv_by_file import ImportCsvByFile
...
class TestApiImportCsvByFile(APITestCase):
    ...
    def test_upload_valid_csv_file(self):
        ...
        request = factory.post('/import-csv-by-file', {'file': uploaded_file},
                               'multipart')
        view = ImportCsvByFile.as_view()
    ...
    def test_no_file_uploaded(self):
        ...
        """
        factory = APIRequestFactory()
        request = factory.post('/import-csv-by-file')
        view = ImportCsvByFile.as_view()
        response = view(request)
