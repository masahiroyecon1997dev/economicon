...
class ImportExcelByPath(AbstractApi):
    """
    Excel繝輔ぃ繧､繝ｫ繝代せ謖・ｮ壹〒繝・・繧ｿ繧偵う繝ｳ繝昴・繝医＠縺ｦ繝・・繝悶Ν繧剃ｽ懈・縺吶ｋAPI繧ｯ繝ｩ繧ｹ

    謖・ｮ壹＆繧後◆繝代せ縺ｮExcel繝輔ぃ繧､繝ｫ繧定ｧ｣譫舌＠縲∵欠螳壹＆繧後◆繝・・繝悶Ν蜷阪〒逋ｻ骭ｲ縺励∪縺吶・    繧ｷ繝ｼ繝亥錐繧呈欠螳壹〒縺阪∪縺吶・    """
    ...
    def execute(self):
        # Excel繝輔ぃ繧､繝ｫ縺ｮ繧､繝ｳ繝昴・繝亥・逅・        try:
            # Excel繝輔ぃ繧､繝ｫ繧単olars繝・・繧ｿ繝輔Ξ繝ｼ繝縺ｫ螟画鋤
            if self.sheet_name:
...
def import_excel_by_path(file_path: str,
    ...
    """
    EXCEL繝輔ぃ繧､繝ｫ繝代せ縺九ｉ繝・・繧ｿ繧偵う繝ｳ繝昴・繝医＠縺ｦ繝・・繝悶Ν繧剃ｽ懈・縺吶ｋ髢｢謨ｰ

    Args:
        file_path: EXCEL繝輔ぃ繧､繝ｫ縺ｮ繝代せ
        table_name: 菴懈・縺吶ｋ繝・・繝悶Ν蜷・        sheet_name: 繧ｷ繝ｼ繝亥錐・医ョ繝輔か繝ｫ繝・ None・・
    Returns:
