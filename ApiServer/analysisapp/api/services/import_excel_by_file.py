...
class ImportExcelByFile(AbstractApi):
    """
    EXCEL繝輔ぃ繧､繝ｫ縺九ｉ繝・・繧ｿ繧偵う繝ｳ繝昴・繝医＠縺ｦ繝・・繝悶Ν繧剃ｽ懈・縺吶ｋAPI繧ｯ繝ｩ繧ｹ

    繧｢繝・・繝ｭ繝ｼ繝峨＆繧後◆Excel繝輔ぃ繧､繝ｫ繧定ｧ｣譫舌＠縲∵眠縺励＞繝・・繝悶Ν縺ｨ縺励※逋ｻ骭ｲ縺励∪縺吶・    繝・・繝悶Ν蜷阪・繝輔ぃ繧､繝ｫ蜷阪°繧芽・蜍慕函謌舌＆繧後∪縺吶・    """
...
def import_excel_by_file(file_data: BinaryIO, file_name: str) -> Dict:
    """
    Excel繝輔ぃ繧､繝ｫ縺九ｉ繝・・繧ｿ繧偵う繝ｳ繝昴・繝医＠縺ｦ繝・・繝悶Ν繧剃ｽ懈・縺吶ｋ髢｢謨ｰ

    Args:
        file_data: Excel繝輔ぃ繧､繝ｫ縺ｮ繝舌う繝翫Μ繝・・繧ｿ
        file_name: Excel繝輔ぃ繧､繝ｫ縺ｮ蜷榊燕
