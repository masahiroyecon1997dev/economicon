...
If you have any questions regarding the usage of this project for educational purposes, or if you're interested in collaboration, feel free to reach out:

- **Email**: `masahiroyecon1997dev@gmail.com`

> [!NOTE]
> For bug reports and feature requests, please use the [GitHub Issues](https://github.com/masahiroyecon1997dev/economicon/issues) page.
...
本プロジェクトを学習目的で利用される際のご質問や、共同開発・コラボレーションのご提案などは、以下の窓口までお気軽にお問い合わせください。
