...
class GetFiles:
    ...
    def __init__(self, directory_path: str):
        ...
        self.param_names = {"directory_path": "directoryPath"}
    ...
    def execute(self):
        try:
            ...
            result = {"directoryPath": self.directory_path, "files": files}
            return result

        except Exception as e:
            message = _(
                "An unexpected error occurred during listing files processing"
            )
