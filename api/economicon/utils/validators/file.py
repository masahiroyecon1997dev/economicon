...
def validate_directory_path(directory: str, directory_param: str) -> None:
    validate_required(directory, directory_param)
    validate_directory_path_exists(directory, directory_param)


def validate_directory_path_is_directory(directory: str) -> None:
...
def validate_separator(separator: str, separator_param: str) -> None:
    validate_string_length(
        separator,
        separator_param,
        min_length=1,
...
def validate_sheet_name(
    sheet_name: Optional[str], sheet_name_param: str
) -> None:
