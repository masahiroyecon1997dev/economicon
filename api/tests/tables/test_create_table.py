...
def test_create_table_pydantic_missing_table_name(client, tables_store):
    ...
    """
    payload = {"tableNumberOfRows": 3, "columnNames": ["A", "B"]}
    response = client.post(
        "/api/table/create",
        json=payload,
    )
...
def test_create_table_pydantic_missing_number_of_rows(client, tables_store):
    ...
    """
    payload = {"tableName": "TestTable", "columnNames": ["A", "B"]}
    response = client.post(
        "/api/table/create",
        json=payload,
    )
...
def test_create_table_pydantic_missing_column_names(client, tables_store):
    ...
    """
    payload = {"tableName": "TestTable", "tableNumberOfRows": 3}
    response = client.post(
        "/api/table/create",
        json=payload,
    )
