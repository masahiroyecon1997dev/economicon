...
def test_duplicate_table_success(client, prepared_data):
    ...
    # 正常にテーブル複製できる
    payload = {"tableName": "TestTable", "newTableName": "DuplicatedTable"}
...
def test_duplicate_table_empty_table(client, prepared_data):
    ...
    duplicated_df = tables_store.get_table("DuplicatedEmptyTable").table
...
def test_duplicate_table_pydantic_empty_table_name(client, prepared_data):
    ...
    """
    payload = {"tableName": "", "newTableName": "DuplicatedTable"}
    response = client.post(
        "/api/table/duplicate",
        json=payload,
    )
...
def test_duplicate_table_pydantic_empty_new_table_name(client, prepared_data):
    ...
    """
    payload = {"tableName": "TestTable", "newTableName": ""}
    response = client.post(
        "/api/table/duplicate",
        json=payload,
    )
...
def test_duplicate_table_pydantic_missing_table_name(client, prepared_data):
    ...
    """
    payload = {"newTableName": "DuplicatedTable"}
    response = client.post(
        "/api/table/duplicate",
        json=payload,
    )
...
def test_duplicate_table_pydantic_missing_new_table_name(
