...
import { LinearRegressionForm } from "../Form/LinearRegressionForm";
import { RegressionResult } from "../Result/RegressionResult";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "./BaseTab";

type RegressionTabProps = {
  className?: string;
};

export const RegressionTab = ({ className }: RegressionTabProps) => {
