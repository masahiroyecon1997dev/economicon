...
Write-Step "[1/10] Python $PYTHON_VERSION Embedded Package の準備"
...
Write-Step "[3/10] Python 本体を bin/ へコピー (サイドカー用)"
...
Write-Step "[4/10] Python 依存パッケージのインストール (uv --target)"
...
Write-Step "[5/10] API ファイルを resources/ へコピー"
...
# ==============================================================================
#  STEP 6: Python プリコンパイル（.py → .pyc）
# ==============================================================================

Write-Step "[6/10] Python プリコンパイル (.py → .pyc)"
...
Write-Step "[7/10] Frontend ビルド (pnpm build)"
...
Write-Step "[8/10] Tauri ビルド (pnpm tauri build)"
...
Write-Step "[9/10] 成果物を release/ へ集約"
