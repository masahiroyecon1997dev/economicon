...
Write-Step "[1/7] Python $PYTHON_VERSION Embedded Package の準備"
...
Write-Step "[3/7] Python 依存パッケージのインストール (uv --target)"
...
Write-Step "[4/7] Frontend ビルド (pnpm build)"
...
Write-Step "[5/7] Tauri ビルド (pnpm tauri build)"
...
Write-Step "[6/7] 成果物を release/ へ集約"
