/**
 * C-21 分析結果の出力（LaTeX/Markdown） — Remotion コンポジション
 *
 * 素材: captured/c21/frames/0001.jpg … NNNN.jpg + meta.json
 *
 * フレーム構成:
...
export const calculateC21Metadata: CalculateMetadataFunction<
  C21Props
> = async ({ props }) => {
  try {
    const res = await fetch(staticFile("c21/meta.json"));
