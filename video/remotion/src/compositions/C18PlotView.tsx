/**
 * C-18 散布図・ヒストグラムの作成 — Remotion コンポジション
 *
 * 素材: captured/c18/frames/0001.jpg … NNNN.jpg + meta.json
 *
 * フレーム構成:
...
export const calculateC18Metadata: CalculateMetadataFunction<
  C18Props
> = async ({ props }) => {
  try {
    const res = await fetch(staticFile("c18/meta.json"));
...
export const C18PlotView: React.FC<C18Props> = ({ lang = "ja", _meta }) => {
  const t = I18N[lang].C18;
