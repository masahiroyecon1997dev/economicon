 ...
 * Remotion コンポジション
 *
 * 素材: captured/c23/frames/0001.jpg … NNNN.jpg + meta.json
 *
 * フレーム構成:
...
export const calculateC23Metadata: CalculateMetadataFunction<
  C23Props
> = async ({ props }) => {
  try {
    const res = await fetch(staticFile("c23/meta.json"));
...
export const C23OlsSimulation: React.FC<C23Props> = ({
  lang = "ja",
  _meta,
}) => {
  const t = I18N[lang].C23;
