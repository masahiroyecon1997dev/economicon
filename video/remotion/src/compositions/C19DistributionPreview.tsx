/**
 * C-19 確率分布プレビュー — Remotion コンポジション
 *
 * 素材: captured/c19/frames/0001.jpg … NNNN.jpg + meta.json
 *
 * フレーム構成:
...
export const calculateC19Metadata: CalculateMetadataFunction<
  C19Props
> = async ({ props }) => {
  try {
    const res = await fetch(staticFile("c19/meta.json"));
...
export const C19DistributionPreview: React.FC<C19Props> = ({
  lang = "ja",
  _meta,
}) => {
  const t = I18N[lang].C19;
